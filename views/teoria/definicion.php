...
<body>
      ...
      <div class="row flex-nowrap">
        ...
        <div style="position: relative; width: 100%; height: 0; padding-top: 60%;
            ...
            <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;"
                  src="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAF1acc_eTo&#x2F;view?embed" allowfullscreen="allowfullscreen" allow="fullscreen">
            </iframe>
          </div>
        </div>
      </div>
    ...
    <script>
        function iniciarSoftware() {
            // Redirigir a la siguiente ventana o realizar acciones necesarias.
            // Puedes utilizar window.location.href = "URL_de_tu_pagina_siguiente.html";
        }
    </script>
